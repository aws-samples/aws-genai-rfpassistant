      ...
      content={
        <ContentLayout
          header={
            <Header
              variant="h1"
              description="The RFP Assistant is designed to solve this problem by creating a digital knowledgebase of existing documents and then use semantic search to create human like responses. "
              actions={
                <RouterButton
                  iconAlign="right"
                  iconName="contact"
