...
>;
export const listSessions = /* GraphQL */ `query ListSessions($sessionType: String!) {
  listSessions(sessionType: $sessionType) {
    id
    title
    startTime
    s3ObjectKey
...
>;
export const getSession = /* GraphQL */ `query GetSession($id: String!, $sessionType: String!) {
  getSession(id: $id, sessionType: $sessionType) {
    id
    title
    startTime
    s3ObjectKey
