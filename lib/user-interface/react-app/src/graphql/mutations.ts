...
>;
export const deleteUserSessions = /* GraphQL */ `mutation DeleteUserSessions($sessionType: String!) {
  deleteUserSessions(sessionType: $sessionType) {
    id
    deleted
    __typename
  }
...
>;
export const deleteSession = /* GraphQL */ `mutation DeleteSession($id: String!, $sessionType: String!) {
  deleteSession(id: $id, sessionType: $sessionType) {
    id
    deleted
    __typename
  }
...
>;
export const downloadFile = /* GraphQL */ `mutation DownloadFile($SessionId: String!, $S3ObjectKey: String) {
  downloadFile(SessionId: $SessionId, S3ObjectKey: $S3ObjectKey) {
    id
    s3Uri
    __typename
  }
...
` as GeneratedMutation<
  APITypes.DownloadFileMutationVariables,
  APITypes.DownloadFileMutation
>;
