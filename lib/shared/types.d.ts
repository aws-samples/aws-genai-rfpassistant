...
export declare type ModelProvider = "sagemaker" | "bedrock" | "openai";
export declare enum SupportedSageMakerModels {
...
export declare enum SupportedRegion {
...
export declare enum SupportedBedrockRegion {
    AP_NORTHEAST_1 = "ap-northeast-1",
    AP_SOUTHEAST_1 = "ap-southeast-1",
    AP_SOUTHEAST_2 = "ap-southeast-2",
    EU_CENTRAL_1 = "eu-central-1",
...
export declare enum ModelInterface {
    LangChain = "langchain",
